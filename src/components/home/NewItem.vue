            ...
            <div id="so_listing_tabs_2" class="so-listing-tabs first-load">
                ...
                <div class="ltabs-wrap">
                    <div class="ltabs-tabs-container" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="1" data-md="1" data-sm="1" data-xs="1" data-margin="0">
                        <!--Begin Tabs-->
                        <div class="ltabs-tabs-wrap"> <span class='ltabs-tab-selected'></span>
                            <span class="ltabs-tab-arrow">▼</span>
                            <ul class="ltabs-tabs cf list-sub-cat font-title">
                                <li class="ltabs-tab tab-sel" data-category-id="51" data-active-content=".items-category-51"><span class="ltabs-tab-label">Bathroom</span>
                                </li>
                                <li class="ltabs-tab  " data-category-id="52" data-active-content=".items-category-52"> <span class="ltabs-tab-label">Bedroom</span>
                                </li>
                                <li class="ltabs-tab  " data-category-id="53" data-active-content=".items-category-53"> <span class="ltabs-tab-label">Decor</span>
                                </li>
                            </ul>
                        </div>
                        <!-- End Tabs-->
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Pastrami bacon">
                                                        <img src="image/catalog/demo/product/funiture/10.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                        <img src="image/catalog/demo/product/funiture/9.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Chicken swinesha">
                                                        <img src="image/catalog/demo/product/270/15.jpg" class="img-1 img-responsive" alt="image">
                                                        <img src="image/catalog/demo/product/270/2.jpg" class="img-2 img-responsive" alt="image">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                        <img src="image/catalog/demo/product/270/14.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                        <img src="image/catalog/demo/product/270/3.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Sausage cowbee">
                                                        <img src="image/catalog/demo/product/270/13.jpg" class="img-1 img-responsive" alt="image">
                                    ...
                                    <div class="item-inner product-layout transition product-grid">
                                        <div class="product-item-container">
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Kielbasa hamburg">
                                                        <img src="image/catalog/demo/product/270/12.jpg" class="img-1 img-responsive" alt="Pastrami bacon">
                                                        <img src="image/catalog/demo/product/270/5.jpg" class="img-2 img-responsive" alt="Pastrami bacon">
                                                    </a>
                                                </div>
                                                <div class="button-group so-quickview cartinfo--left">
                                                    <button type="button" class="addToCart btn-button" title="Add to cart" onclick="cart.add('60 ');"> <i class="fa fa-shopping-basket"></i>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container second_img">
                                                    <a href="product.html" target="_self" title="Balltip nullaelit">
                                                        <img src="image/catalog/demo/product/270/11.jpg" class="img-1 img-responsive" alt="image">
